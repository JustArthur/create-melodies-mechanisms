...
@Mod("create_melodies_mechanisms")
public class CreateMelodiesMechanismsMod {
	public static final Logger LOGGER = LogManager.getLogger(CreateMelodiesMechanismsMod.class);
	public static final String MODID = "create_melodies_mechanisms";

	public CreateMelodiesMechanismsMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();

		CreateMelodiesMechanismsModItems.REGISTRY.register(bus);

		CreateMelodiesMechanismsModTabs.REGISTRY.register(bus);
